...
const Portfolio = () => {
    ...
    let project = {
        "text": "<h1 id=\"bice\">BICE</h1>\n" +
            "<h3 id=\"la-brigade-d-intervention-en-condition-extrem\">La Brigade d&#39;Intervention en Condition Extrem</h3>\n" +
            "<h2 id=\"probl-matique\">Problématique</h2>\n" +
